...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_el_scrollbar, {
    ...
    default: withCtx(() => [
      ...
      _ctx.isEmpty ? (openBlock(), createElementBlock("div", _hoisted_1$1, toDisplayString(_ctx.t("el.cascader.noData")), 1)) : _ctx.panel.isHoverMenu ? (openBlock(), createElementBlock("svg", _hoisted_2$1, null, 512)) : createCommentVNode("v-if", true)
    ]),
    _: 1
