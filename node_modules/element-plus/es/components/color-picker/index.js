import { defineComponent, getCurrentInstance, ref, watch, onMounted, openBlock, createElementBlock, normalizeClass, createElementVNode, normalizeStyle, computed, inject, watchEffect, Fragment, renderList, reactive, nextTick, provide, resolveComponent, resolveDirective, createBlock, withCtx, withDirectives, createVNode, createCommentVNode, withKeys, createTextVNode, toDisplayString, vShow } from 'vue';
...
const _hoisted_3$2 = { class: "el-color-dropdown__value" };
const _hoisted_4$1 = {
  key: 0,
  ...
  return openBlock(), createBlock(_component_el_popper, {
    ...
    trigger: withCtx(() => [
      createElementVNode("div", {
        ...
        _ctx.colorDisabled ? (openBlock(), createElementBlock("div", _hoisted_4$1)) : createCommentVNode("v-if", true),
        createElementVNode("div", {
