...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("button", {
    ...
    _ctx.prevText ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(_ctx.prevText), 1)) : (openBlock(), createElementBlock("i", _hoisted_3))
  ], 8, _hoisted_1);
}
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("span", _hoisted_1$4, toDisplayString(_ctx.t("el.pagination.total", {
    total: _ctx.total
  })), 1);
}
  ...
  return openBlock(), createElementBlock("ul", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.pagers, (pager) => {
      return openBlock(), createElementBlock("li", {
        ...
        tabindex: "0"
      }, toDisplayString(pager), 11, _hoisted_2$2);
    }), 128)),
    ...
    _ctx.pageCount > 1 ? (openBlock(), createElementBlock("li", {
      ...
      tabindex: "0"
    }, toDisplayString(_ctx.pageCount), 11, _hoisted_3$2)) : createCommentVNode("v-if", true)
  ], 32);
}
