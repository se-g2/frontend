...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      ...
      _ctx.node.loading ? (openBlock(), createElementBlock("span", _hoisted_2)) : createCommentVNode("v-if", true),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    _ctx.isEmpty ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
      createElementVNode("span", _hoisted_2$1, toDisplayString(_ctx.emptyText || _ctx.t("el.tree.emptyText")), 1)
    ])) : createCommentVNode("v-if", true),
