...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(_component_el_scrollbar, {
    ...
    default: vue.withCtx(() => [
      ...
      _ctx.isEmpty ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, vue.toDisplayString(_ctx.t("el.cascader.noData")), 1)) : _ctx.panel.isHoverMenu ? (vue.openBlock(), vue.createElementBlock("svg", _hoisted_2$1, null, 512)) : vue.createCommentVNode("v-if", true)
    ]),
    _: 1
...
const useCascaderConfig = (props) => {
  return vue.computed(() => __spreadValues(__spreadValues({}, DefaultProps), props.props));
};
