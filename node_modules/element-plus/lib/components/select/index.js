      ...
      trigger: vue.withCtx(() => [
        vue.createElementVNode("div", _hoisted_1, [
          _ctx.multiple ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            style: vue.normalizeStyle({ "max-width": _ctx.inputWidth - 32 + "px", width: "100%" })
          }, [
              ...
              vue.createVNode(_component_el_tag, {
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("span", {
                    ...
                    style: vue.normalizeStyle({ "max-width": _ctx.inputWidth - 123 + "px" })
            ...
            !_ctx.collapseTags ? (vue.openBlock(), vue.createBlock(vue.Transition, {
              ...
              default: vue.withCtx(() => [
                vue.createElementVNode("span", {
                  style: vue.normalizeStyle({ marginLeft: _ctx.prefixWidth && _ctx.selected.length ? `${_ctx.prefixWidth}px` : null })
                }, [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.selected, (item) => {
                    return vue.openBlock(), vue.createBlock(_component_el_tag, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createElementVNode("span", {
                          class: "el-select__tags-text",
                          style: vue.normalizeStyle({ "max-width": _ctx.inputWidth - 75 + "px" })
            ...
            _ctx.filterable ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("input", {
              ...
              style: vue.normalizeStyle({ marginLeft: _ctx.prefixWidth && !_ctx.selected.length || _ctx.tagInMultiLine ? `${_ctx.prefixWidth}px` : null, flexGrow: "1", width: `${_ctx.inputLength / (_ctx.inputWidth - 32)}%`, maxWidth: `${_ctx.inputWidth - 42}px` }),
          ...
          vue.createVNode(_component_el_input, {
            ...
            suffix: vue.withCtx(() => [
              vue.withDirectives(vue.createElementVNode("i", {
                class: vue.normalizeClass(["el-select__caret", "el-input__icon", "el-icon-" + _ctx.iconClass])
              }, null, 2), [
        ...
        vue.createVNode(_component_el_select_menu, null, {
          default: vue.withCtx(() => [
            vue.withDirectives(vue.createVNode(_component_el_scrollbar, {
              ...
              class: vue.normalizeClass({ "is-empty": !_ctx.allowCreate && _ctx.query && _ctx.filteredOptionsCount === 0 })
            }, {
              default: vue.withCtx(() => [
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("ul", _hoisted_1$1, [
    vue.createElementVNode("li", _hoisted_2$1, vue.toDisplayString(_ctx.label), 1),
