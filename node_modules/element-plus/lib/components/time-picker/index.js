...
const _hoisted_4 = { class: "el-time-spinner__arrow el-icon-arrow-down" };
const _hoisted_5 = { class: "el-time-spinner__list" };
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    _ctx.arrowControl ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 1 }, vue.renderList(_ctx.spinnerItems, (item) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.withDirectives(vue.createElementVNode("i", _hoisted_4, null, 512), [
        ...
        vue.createElementVNode("ul", _hoisted_5, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.arrowListMap[item].value, (time, key) => {
            return vue.openBlock(), vue.createElementBlock("li", {
              key,
              class: vue.normalizeClass(["el-time-spinner__item", { "active": time === _ctx.timePartsMap[item].value, "disabled": _ctx.listMap[item].value[time] }])
...
const _hoisted_2$2 = { class: "el-time-panel__footer" };
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(vue.Transition, { name: _ctx.transitionName }, {
    default: vue.withCtx(() => [
      _ctx.actualVisible || _ctx.visible ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
...
const _hoisted_2$3 = { class: "el-time-range-picker__content" };
const _hoisted_3$2 = { class: "el-time-range-picker__cell" };
const _hoisted_4$1 = { class: "el-time-range-picker__header" };
const _hoisted_5$1 = { class: "el-time-range-picker__cell" };
const _hoisted_6 = { class: "el-time-range-picker__header" };
const _hoisted_7 = { class: "el-time-panel__footer" };
const _hoisted_8 = ["disabled"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_time_spinner = vue.resolveComponent("time-spinner");
  return _ctx.actualVisible ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [
    vue.createElementVNode("div", _hoisted_2$3, [
      vue.createElementVNode("div", _hoisted_3$2, [
        vue.createElementVNode("div", _hoisted_4$1, vue.toDisplayString(_ctx.t("el.datepicker.startTime")), 1),
        vue.createElementVNode("div", {
...
var TimePicker = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      return vue.h(script, __spreadProps(__spreadValues({}, props), {
        format,
        type,
        ref: commonPicker,
